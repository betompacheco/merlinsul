...
public class NumberCodeGenerator {
    ...
    private String criaLinhaDigitavel(String DAC, String codigoBarrasSemDAC) {
        ...
        tmp.append(Utilitario.complete(Integer.toString(numeroMoeda), 1, "0")); // 04 a 04, C√≥digo da Moeda (Real = 9)
        ...
        // Adiciona o quarto bloco, que √© o digito verificador do codigo de barras. O codigo de barras tem que ser calculado antes.
        codigo.append(DAC);
    ...
    public int calculaModulo11base9(String valor) {
        ...
        int resto = tmp % 11;
        int result = resto;
        // Se o resto da divis√£o for igual a 0 (zero) ou 10, o primeiro d√≠gito verificador ser√° igual a 0 (zero).
        if (resto == 0 || resto == 10) {
            result = 0;
        }
    ...
    public String calculaDACdoBradesco(String valor) {
        ...
        //Se o resto da divis√£o for ‚Äú1‚Äù, desprezar a diferen√ßa entre o divisor
        //menos o resto que ser√° ‚Äú10‚Äù e considerar o d√≠gito como ‚ÄúP‚Äù.
        if (resto == 1) {
            return "P";
        }
        //Se o resto da divis√£o for ‚Äú0‚Äù, desprezar o c√°lculo de subtra√ß√£o entre
        //divisor e resto, e considerar o ‚Äú0‚Äù como d√≠gito.
        if (resto == 0) {
            result = 0;
        }
    ...
    // Calcula o Digito de Autoconfer√™ncia (DAC) do Bradesco
    public int calculaDAC(String valor) {
        ...
        //Os resultados das multiplicaÁıes devem ser acumulados
        for (int i = valor.length() - 1; i > -1; i--) {
            int vl = valor.charAt(i) - 48;
            int vlbase = pesos[iPeso];
            int tot = vl * vlbase;
        ...
        //No final, o valor acumulado dever· ser dividido por 11
        int resto = tmp % 11;

        //O resto da divis„o dever· ser subtraÌdo de 11
        int result = 11 - resto;
        //Se o resultado da subtraÁ„o for igual a 0 (Zero), 1 (um) ou maior que 9 (nove) dever„o assumir o dÌgito igual a 1 (um).
        //Caso contr·rio, o resultado da subtraÁ„o ser· o prÛprio dÌgito.
     ...
     *
     * @param codigoDoSacado C√≥digo do Documento
    ...
    public String comporNossoNumero(long codigoDoSacado, String carteira) {
        ...
        //Retorna o nosso numero j√° formatado de acordo
