  ...
  <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<h:form>
        <table border="0">
          ...
          <tr>
            <td>
				<h:selectOneMenu id="codigoApartamento" value="#{imprimirBoleto.codigoApartamento}"  styleClass="selecao" rendered="false"> 
          ...
          <tr>
            <td>Ano:</td>
            <td><h:selectOneMenu id="ano"  value="#{imprimirBoleto.ano}"  styleClass="selecao" required="true"> 
          ...
          <tr>
            <td>M&ecirc;s:</td>
            <td><h:selectOneMenu id="mes" value="#{imprimirBoleto.mes}"  styleClass="selecao"  required="true"> 
					<f:selectItem itemValue="" itemLabel=""/>
          ...
          <tr>
            <td>Mensagem:</td>
            <td><h:selectOneRadio id="mensagem" value="#{imprimirBoleto.mensagem}"  styleClass="selecao"  required="true" layout="pageDirection"> 
