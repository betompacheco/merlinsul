                                ...
                                <td width="99%">&nbsp;
                                    ...
                                    <h:form id="formTb" >
                                        ...
                                        <table border="0">
                                            ...
                                            <tr>
                                                <td>Apartamento:</td>
                                                <td><h:selectOneMenu id="codigoApartamento" value="#{incluirVeiculo.codigoApartamento}"   styleClass="styled-select" required="true">
                                            ...
                                            <tr>
                                                <td>Tipo:</td>
                                                <td><h:selectOneMenu id="tipo" value="#{incluirVeiculo.tipoVeiculo}"  styleClass="styled-select" required="true">
                                            ...
                                            <tr>
                                                <td>Fabricante:</td>
                                                <td><h:selectOneMenu id="fabricante" value="#{incluirVeiculo.fabricanteVeiculo}"  styleClass="styled-select" required="true">
                                                        <f:selectItem itemValue="" itemLabel=""/>
