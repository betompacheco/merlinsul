                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td width="99%">&nbsp;
                                    <!-- inicio do conteudo -->
                                    <h:form id="formTb" >
                                        <h:inputHidden id="codigoendereco" value="#{incluirEndereco.codigoendereco}"/>
                                        <table border="0">
                                            <tr>
                                                <td colspan="3"><h2>Inclus&atilde;o de Endere&ccedil;o</h2></td>
                                            </tr>
                                            <tr>
                                                <td>Apartamento:</td>
                                            ...
                                            <tr>
                                                <td>Logradouro:</td>
                                                <td><h:inputText id="logradouro" value="#{incluirEndereco.logradouro}" styleClass="caixadetexto" required="true" size="30" maxlength="30" > </h:inputText>
                                                <td><h:message for="logradouro" errorClass="erros"/></td>
                                            </tr>
                                            <tr>
                                                <td>Complemento:</td>
                                                <td><h:inputText id="complemento" value="#{incluirEndereco.complemento}" styleClass="caixadetexto" required="true" size="15" maxlength="15" > </h:inputText>
                                                <td><h:message for="complemento" errorClass="erros"/></td>
                                            </tr>
                                            <tr>
                                                <td>Bairro:</td>
                                                <td><h:inputText id="bairro" value="#{incluirEndereco.bairro}" styleClass="caixadetexto" required="true" size="25" maxlength="25" > </h:inputText>
                                                <td><h:message for="bairro" errorClass="erros"/></td>
                                            </tr>
                                            <tr>
                                                <td>Cidade:</td>
                                                <td><h:inputText id="cidade" value="#{incluirEndereco.cidade}" styleClass="caixadetexto" required="true" size="30" maxlength="30" > </h:inputText>
                                            ...
                                            <tr>
                                                ...
                                                <td><h:selectOneMenu id="uf" value="#{incluirEndereco.uf}"  styleClass="selecao" required="true">
                                                        ...
                                                        <f:selectItem itemValue="Espirito Santo" itemLabel="Espirito Santo"/>
                                            ...
                                            <tr>
                                                ...
                                                <td><h:selectBooleanCheckbox id="enderecocobranca" value="#{incluirEndereco.enderecoCobranca}" styleClass="caixabooleano"/> </td>
                                                <td><h:message for="enderecocobranca" errorClass="erros"/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><h:commandButton value="Salvar" action="#{incluirEndereco.doIncluir}" styleClass="botao" /></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><h:outputText value="#{incluirEndereco.mensagem}" styleClass="mensagem"/></td>
                                            </tr>
                                        </h:form>
                                    </table></td>
                                </body>
