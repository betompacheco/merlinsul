					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="99%">&nbsp; <!-- inicio do conteudo --> <h:form
									...
									<table border="0">
										<tr>
											<td colspan="3"><h2>Consulta de Proprietario</h2></td>
										</tr>
										<tr>
											<td>Crit&eacute;rio:</td>
											<td><h:inputText id="criterio"
													value="#{consultarProprietario.criterio}"
													styleClass="caixadetexto" size="50" maxlength="50" /></td>
											<td><h:message for="criterio" errorClass="erros" /></td>
										</tr>
										<tr>
											<td colspan="3"><h:commandButton value="Consultar"
													action="#{consultarProprietario.doConsultar}"
													styleClass="botao" /></td>
										</tr>
										<tr>

											<td colspan="3"><h:dataTable
													value="#{consultarProprietario.dados}" var="proprietario"
													...
													<h:column>
														<h:commandButton value="Excluir"
															action="#{consultarProprietario.doExcluir}"
