                            ...
                            <tr>
                                ...
                                <td width="99%">&nbsp;
                                    ...
                                    <h:form id="form">
                                        <table border="0">
                                            <tr>
                                                <td colspan="3"><h2>Consulta de Apartamento</h2>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Crit&eacute;rio:</td>
                                                <td><h:inputText id="criterio" value="#{consultarApartamento.criterio}" styleClass="caixadetexto" size="50" maxlength="50" /></td>
                                                <td><h:message for="criterio" errorClass="erros"/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><h:commandButton value="Consultar" action="#{consultarApartamento.doConsultar}" styleClass="botao" /></td>
                                            </tr>
                                            <tr>
