                            ...
                            <tr>
                                ...
                                <td width="99%">&nbsp;
                                    ...
                                    <h:form>
                                        <table border="0">
                                            <tr>
                                                <td colspan="3"><h2>Impressao de Veiculos </h2></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><h:commandButton value="Consultar" action="#{imprimirVeiculos.doImprimir}" styleClass="botao" /></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <c:if test="${imprimirVeiculos.flagOk}">
