                                    ...
                                    <h:form id="formTb" >
                                        ...
                                        <table border="0">
                                            ...
                                            <tr>
                                                <td>Condominio:</td>
                                                <td>
                                                    <h:selectOneMenu id="codigoCondominio" value="#{incluirApartamento.codigoCondominio}"  styleClass="styled-select" required="true">
                                            ...
                                            <tr>
                                                <td>Proprietario:</td>
                                                <td>
                                                    <h:selectOneMenu id="codigoProprietario" value="#{incluirApartamento.codigoProprietario}"  styleClass="styled-select" required="true">
                                                        <f:validateLongRange minimum="1"/>
