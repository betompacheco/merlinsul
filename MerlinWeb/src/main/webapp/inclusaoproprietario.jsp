  ...
  <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="99%">&nbsp;
        <!-- inicio do conteudo -->
		<h:form id="formTb" >
				<h:inputHidden id="codigoProprietario" value="#{incluirProprietario.codigoproprietario}"/>        
        <table border="0">
          <tr>
          ...
          <tr>
            <td>sexo:</td>
            <td><h:selectOneRadio layout="lineDirection" value="#{incluirProprietario.sexo}" required="true">
          ...
          <tr>
            <td>Identidade:</td>
            <td><h:inputText id="identidade" value="#{incluirProprietario.identidade}" styleClass="caixadetexto" required="true" size="10" maxlength="10" />
            </td>
            <td><h:message for="identidade" errorClass="erros"/></td>
          </tr>
          <tr>
            <td>cpf:</td>
            <td><h:inputText id="cpf" value="#{incluirProprietario.cpf}" styleClass="caixadetexto" required="true" size="12" maxlength="12" />
            </td>
            <td><h:message for="cpf" errorClass="erros"/></td>
          </tr>
          <tr>
            <td>Profiss&atilde;o:</td>
            <td><h:inputText id="profissao" value="#{incluirProprietario.profissao}" styleClass="caixadetexto" required="true" size="25" maxlength="25" />
            </td>
            <td><h:message for="profissao" errorClass="erros"/></td>
          </tr>
          <tr>
            <td>Filia&ccedil;&atilde;o:</td>
            <td><h:inputText id="filiacao" value="#{incluirProprietario.filiacao}" styleClass="caixadetexto" required="true" size="30" maxlength="30" />
            </td>
            <td><h:message for="filiacao" errorClass="erros"/></td>
          </tr>
          <tr>
            <td>Telefone Residencial:</td>
            <td><h:inputText id="telResidencial" value="#{incluirProprietario.telResidencial}" styleClass="caixadetexto" size="14" maxlength="14" />
            </td>
            <td><h:message for="telResidencial" errorClass="erros"/></td>
          </tr>
          <tr>
            <td>Telefone Comercial:</td>
            <td><h:inputText id="telComercial" value="#{incluirProprietario.telComercial}" styleClass="caixadetexto" size="14" maxlength="14" />
            </td>
            <td><h:message for="telComercial" errorClass="erros"/></td>
          </tr>
          <tr>
            <td>Telefone Celular:</td>
            <td><h:inputText id="telCelular" value="#{incluirProprietario.telCelular}" styleClass="caixadetexto" size="14" maxlength="14" />
            </td>
            <td><h:message for="telCelular" errorClass="erros"/></td>
          </tr>
          <tr>
            <td colspan="3"><h:commandButton value="Salvar" action="#{incluirProprietario.doIncluir}" styleClass="botao" />
            </td>
          </tr>
          <tr>
          	<td colspan="3"><h:outputText value="#{incluirProprietario.mensagem}"/></td>
          </tr>
