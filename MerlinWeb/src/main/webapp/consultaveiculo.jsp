...
<%@ page contentType="text/html; charset=iso-8859-1" language="java" errorPage="error.jsp" %><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
    <f:view>
        <head>
                            ...
                            <tr>
                                ...
                                <td width="99%">&nbsp;
                                    ...
                                    <h:form id="form">
                                        <table border="0">
                                            <tr>
                                                <td colspan="3"><h2>Consulta de Ve&iacute;culo </h2></td>
                                            </tr>
                                            <tr>
                                                <td>Crit&eacute;rio:</td>
                                                <td><h:inputText id="criterio" value="#{consultarVeiculo.criterio}" styleClass="caixadetexto" size="50" maxlength="50" /></td>
                                                <td><h:message for="criterio" errorClass="erros"/></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3"><h:commandButton value="Consultar" action="#{consultarVeiculo.doConsultar}" styleClass="botao" /></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <h:dataTable value="#{consultarVeiculo.dados}" var="veiculo"
                                                        ...
                                                        <h:column>
                                                            <h:commandButton value="Editar" action="#{consultarVeiculo.doEditar}" styleClass="botao" immediate="true"/>
                                                        </h:column>
                                                        <h:column>
                                                            <h:commandButton value="Excluir" action="#{consultarVeiculo.doExcluir}" onclick="javascript: return confirm('Confirmar exclusão');" styleClass="botao" />
                                                        </h:column>
