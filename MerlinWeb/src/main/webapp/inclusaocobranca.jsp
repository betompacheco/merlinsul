						...
						<tr>
							...
							<td width="99%">&nbsp; <!-- inicio do conteudo --> <h:form
									...
									<table border="0" width="80%">
										...
										<tr>
											<td class="input_formulario" width="130">Data de
												Vencimento:</td>
										...
										<tr>
											...
											<td colspan="2"><h:inputText id="valorMulta"
													value="#{gerarCobranca.multa}" styleClass="caixadetexto"
										...
										<c:if test="${gerarCobranca.flagConfirma}">
											<tr>
												<td colspan="3">Ja existe cobrança gerada para este
													mês. Gerar Novamente?&emsp;&emsp;<h:commandButton
														value="Confirmar" action="#{gerarCobranca.confirma}" />
												</td>
										...
										<c:if test="${gerarCobranca.temDados}">
											<tr>
												<td colspan="3"><h:commandButton
														value="Armazenar cobranças"
														action="#{gerarCobranca.doSalvar}" /></td>

											</tr>
											<tr>
												<td colspan="3"><h:dataTable
														value="#{gerarCobranca.dados}" var="cobranca"
														...
														<h:column>
															...
															<h:outputText
																value="#{cobranca.apartamento.condominio.nomecondominio}" />
														</h:column>
														<h:column>
															<f:facet name="header">
															...
															<h:outputText
																value="#{cobranca.apartamento.numeroapartamento}" />
														</h:column>
														<h:column>
															<f:facet name="header">
